  ...
  return (
    <main className="p-3 max-w-lg mx-auto">
      ...
      <div className="w-full">
        ...
        <button className='w-full bg-button text-white p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80' id="button" onClick={() => {submitPrices()}} disabled={buttonDisabled || loading}>Guardar precios</button>

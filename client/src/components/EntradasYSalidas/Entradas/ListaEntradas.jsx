...
export default function ListaEntradas({ inputs, spliceInput, changeInputsIsOpenValue, inputsIsOpen }) {
        ...
        < div className='bg-white mt-4 mb-4'>
          ...
          <div>
            ...
            {inputs && inputs.length > 0 && inputs.map((input, index) => (
              <div key={input._id}>
                {(roles.managerRole._id == currentUser.role || currentUser._id == input.employee._id) && (

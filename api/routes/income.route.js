...
import { getIncomes, newIncomeType, getIncomeTypes, deleteIncomeQuery, newBranchIncomeQuery, newCustomerIncomeQuery, getBranchIncomesRequest, newTransferredIncome } from '../controllers/income.controller.js'

const router = express.Router()

router.post('/branch/create', newBranchIncomeQuery)
router.post('/customer/create', newCustomerIncomeQuery)
router.post('/transfer/create', newTransferredIncome)
